...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/developer-AnimStore/Gost-ip6/main/install.sh)
   ```

Custom Version: 

```bash
bash <(curl -Ls https://github.com/masoudgb/developer-AnimStore/raw/v2.1.7/Gost.sh)
   ```
